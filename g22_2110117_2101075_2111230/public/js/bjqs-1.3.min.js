...
jQuery(document).ready(function($) {
    $('#banner-slide').bjqs({
        ...
        nexttext: '<img src="img/arrow_next.png" alt="Seguinte">', // Text for 'next' button (can use HTML)
        prevtext: '<img src="img/arrow_previous.png" alt="Anterior">', // Text for 'previous' button (can use HTML)
...
window.onresize = function(event) {
    $('#banner-slide').css('max-width', $('.slidePanel').width());
};